...
return d+a.substring(e)}for(var e=[{property:"fonts-weight",values:["bold"],tag:"b"},{property:"fonts-style",values:["italic"],tag:"i"}],f=[],g=0;g<e.length;g++){for(var h="("+e[g].property+":\\s*(",i=0;i<e[g].values.length;i++)/* istanbul ignore next: not needed to be tested yet */

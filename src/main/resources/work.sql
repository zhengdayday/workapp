...
create table student_work (id integer not null auto_increment, answer varchar(255), grade bigint, sno varchar(255), wno bigint, work_read varchar(255), work_status varchar(255), primary key (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8
